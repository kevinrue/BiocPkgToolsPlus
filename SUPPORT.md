...
Thanks for using `BiocPkgToolsPlus`! Before filing an issue, there are a
few places to explore and pieces to put together to make the process as
smooth as possible.
...
- If it’s a question: start with
  ...
  package tag](https://support.bioconductor.org/t/BiocPkgToolsPlus) (the
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/kevinrue/BiocPkgToolsPlus/issues/new).
...
requests](https://github.com/kevinrue/BiocPkgToolsPlus/issues) to make
