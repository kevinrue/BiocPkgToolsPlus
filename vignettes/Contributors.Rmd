...
```{r "count_packages_over_time", message=FALSE}
out2 <- count_packages_over_time(
...
```{r "plot_count_packages_over_time", fig.cap="Number of packages maintained by 'Kevin Rue' over time."}
