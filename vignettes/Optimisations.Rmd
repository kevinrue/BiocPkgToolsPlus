...
In contrast to the interactive workclouds produced by `r BiocStyle::CRANpkg("wordcloud2")`,
the `r BiocStyle::CRANpkg("wordcloud")` package can be used to produce static wordclouds,
