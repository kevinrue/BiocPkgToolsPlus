...
This outlines how to propose a change to BiocPkgToolsPlus. For more
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("kevinrue/BiocPkgToolsPlus", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://kevinrue.github.io/BiocPkgToolsPlus/CODE_OF_CONDUCT.md).
